...
**案例**：过去-高塔，现在-星星，未来-太阳

**解读**：你经历了突然的变化和破坏（高塔），这个经历虽然痛苦，但让你重新审视自己的人生。现在你正在重新找到希望和方向（星星），内心逐渐平静，开始相信未来。如果你能保持这种积极的心态，未来将迎来光明和成功（太阳）。

这种连贯的解读比单独说"高塔代表破坏，星星代表希望，太阳代表成功"要有意义得多。
      `,
    },
    {
      id: 2,
            ...
            <div style={{ marginBottom: "20px" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                  ...
                  <span style={{ fontSize: "12px", color: "#D4AF37" }}>{selectedSkill.likes}</span>
                </div>
              </div>
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: selectedSkill.content
                  ...
                  .replace(
                    /# (.*)/g,
                    '<h2 style="color: #FFD700; font-size: 20px; font-weight: 600; margin: 20px 0 12px 0;">$1</h2>',
                  )
                  .replace(
                    /## (.*)/g,
                    '<h3 style="color: #FFD700; font-size: 18px; font-weight: 500; margin: 16px 0 8px 0;">$1</h3>',
                  )
                  .replace(
                    /### (.*)/g,
                    '<h4 style="color: #D4AF37; font-size: 16px; font-weight: 500; margin: 12px 0 6px 0;">$1</h4>',
                  )
                  .replace(/\*\*(.*?)\*\*/g, '<strong style="color: #FFD700;">$1</strong>')
                  .replace(/- (.*)/g, '<li style="margin: 4px 0; padding-left: 8px;">$1</li>')
  ...
  return (
    <div className="starry-background min-h-screen">
      ...
      <div style={{ textAlign: "center", padding: "15px 0 25px" }}>
        <h1 style={{ fontSize: "22px", fontWeight: "600", color: "#FFD700", marginBottom: "6px" }}>指引技巧</h1>
<p style={{ color: "#D4AF37", fontSize: "14px" }}>提升你的卡牌解读能力</p>
      </div>
            ...
            >
              <div style={{ padding: "20px" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                    <Star size={12} style={{ color: "#FFD700" }} />
                    <span style={{ fontSize: "12px", color: "#D4AF37" }}>{skill.likes}</span>
                  </div>
                </div>
              </div>
            </Card>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "12px" }}>
            ...
            >
              ...
              >
                ...
                <span style={{ color: "#F5F5DC", fontSize: "14px", fontWeight: "500" }}>总点赞</span>
              </div>
              <span style={{ color: "#FFD700", fontSize: "20px", fontWeight: "600" }}>
                {skills.reduce((sum, skill) => sum + skill.likes, 0)}
              </span>
            </div>
          </div>
        </div>
