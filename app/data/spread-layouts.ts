...
export const SPREAD_LAYOUTS: Record<string, SpreadLayout> = {
  ...
  情感牌阵: {
    ...
    positions: [
      { id: 1, label: "你", description: "你在这段关系中的状态", x: 15, y: 65, size: "small" },
      { id: 2, label: "对方", description: "对方在这段关系中的状态", x: 50, y: 20, size: "small" },
      { id: 3, label: "关系", description: "你们之间的关系现状", x: 50, y: 50, size: "small" },
      { id: 4, label: "挑战", description: "关系中需要面对的挑战", x: 85, y: 65, size: "small" },
      { id: 5, label: "结果", description: "关系的发展趋势", x: 50, y: 80, size: "small" },
    ],
  },
  ...
  凯尔特十字: {
    ...
    positions: [
      ...
      { id: 3, label: "远因", description: "深层的根本原因", x: 35, y: 75, size: "small" },
      { id: 4, label: "近因", description: "最近的影响因素", x: 35, y: 15, size: "small" },
      { id: 5, label: "可能", description: "可能的发展方向", x: 8, y: 45, size: "small" },
      { id: 6, label: "近况", description: "即将发生的事情", x: 62, y: 45, size: "small" },

      // 右侧竖列 - 更紧凑的垂直分布
      { id: 7, label: "态度", description: "你的内心态度", x: 88, y: 85, size: "small" },
      { id: 8, label: "外界", description: "外界环境影响", x: 88, y: 70, size: "small" },
      { id: 9, label: "指导", description: "内心的指引", x: 88, y: 55, size: "small" },
      { id: 10, label: "结果", description: "最终的结果", x: 88, y: 40, size: "small" },
    ],
  },
}
