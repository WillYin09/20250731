...
export const TAROT_CARDS: TarotCardData[] = [
  ...
  },
  {
    ...
    translation: "转变",
    description:
      "在图上，我们看到转变使者骑着一匹漂亮的白马，手举着一面绘有白色玫瑰的黑旗。他穿着盔甲，这赋予了他引导转变的能力——这表明转变是生命不可避免的一部分。他所骑的白马代表着纯洁，因为转变净化了所有人。在他的身下，所有阶级的人类都躺在泥土中——一个国王和一个贫民，旨在提醒我们转变不区分阶级、种族和性别。 然而，我们还是可以看到远处冉冉升起的太阳，这代表着重生，带来新的开始和新的希望。",
  ...
  },
  {
    ...
    translation: "诱惑",
    description:
      "这张牌中的诱惑使者以他最著名的萨梯尔（Satyr）形式现身，也就是所谓的巴弗灭（Baphomet）。除了半羊半人的身躯外，这诱惑使者还有蝙蝠的翅膀和额头上的倒五角星。他站在一个基座上，上面拴着裸体的一男一女，这似乎要表明诱惑对他们有统治权。男人和女人都有角，似乎表明他们与诱惑相处的时间越长，他们就越不像人。锁链使他们看起来好像被诱惑俘虏了。男人的尾巴上有一团火焰，而女人的尾巴上有一碗葡萄，这分别象征着他们对权力和生活中美好事物的沉迷。 仔细看，男人和女人看起来都不高兴。他们的个人权力已被夺走，这让他们暴露在赤裸之中并感到羞耻。",
  ...
  },
  {
    ...
    translation: "变革",
    description:
      "变革牌描绘了一个依偎在山顶上的高尖塔。一道闪电击中了塔楼，使其燃烧起来。火焰在窗户上爆开，人们从窗户跳出来，这是一种绝望的行为。他们想逃离内部的动荡和破坏。塔是一个象征，象征着建立在错误前提下的野心。变革的毁灭必须发生，以便清除旧的方式，迎接新的东西。",
